 ...
 * @author Maquina 11
 */
public class MostrarMasa extends javax.swing.JFrame {

    /**
     * Creates new form MostrarMasa
     */
    public MostrarMasa() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Numero de Masajistas: ");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        for(SeleccionFutbol seleccion: Arreglo.listaSeleccion){
            if(seleccion instanceof Masajista){
                ...
                fila[4]=((Masajista) seleccion).getTitulacion();
                fila[5]=((Masajista) seleccion).getAniosExperiencia();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarMasa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MostrarMasa().setVisible(true);
            }
        });
    }
