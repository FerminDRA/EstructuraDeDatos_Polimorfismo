 ...
 * @author Maquina 11
 */
public class MostrarFut extends javax.swing.JFrame {

    /**
     * Creates new form MostrarFut
     */
    public MostrarFut() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Numero de Futbolistas: ");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        for(SeleccionFutbol seleccion: Arreglo.listaSeleccion){
            if(seleccion instanceof Futbolista){
                ...
                fila[4]=((Futbolista) seleccion).getDorsal();
                fila[5]=((Futbolista) seleccion).getDemarcacion();
                fila[6]=(seleccion.Concentrarse()+"\n"+seleccion.Viajar()+"\n"+((Futbolista) seleccion).entrenar()+"\n"+((Futbolista) seleccion).jugarPartido());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarFut.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MostrarFut().setVisible(true);
            }
        });
    }
